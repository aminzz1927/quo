 ...
 *//**
	 ...
	 *
	 *//*
		 * @Controller("indexController2") public class IndexController2 {
		 * 
		 ...
		 * 
		 * // as a full path you can use with a File object String pathToFile =
		 * application.getRealPath("/index.html"); // as an input stream all ready for
		 * you to read
		 * 
		 * String content = new String(Files.readAllBytes(Paths.get(pathToFile)));
		 * response.setContentType("text/html;charset=utf-8"); return content;
		 * 
		 * }
		 * 
		 * }
