...
public class Download<T> {
	 ...
	 * @return 工作簿
	 */
	public XSSFWorkbook getWorkbook(List<T> dataList, String sheetName, Class clazz, String[] arrays, String[] template) {
...
//        }
		...
		for (int y = 0; y < template.length; y++) {
			XSSFCell cell = row0.createCell(y);
			cell.setCellValue(arrays[y]);
			createCell(row0, y, arrays[y], Headstyle);
		}
